...
name: create-skill
description: >-
  Create Agent Skills. Use when authoring a new skill or asking about
  SKILL.md structure.
---

# Creating Skills for agents

This skill guides you through creating effective Agent Skills for agents. Skills are markdown files that teach the agent how to perform specific tasks: reviewing PRs using team standards, generating commit messages in a preferred format, querying database schemas, or any specialized workflow.
...
- "Where should this skill be stored?" with options like ["Personal (~/.agents/skills/)", "Project (.agents/skills/)"]
...
- [ ] No Windows-style paths:workflows
